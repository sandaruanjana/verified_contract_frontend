      ...
      <div class="form-body">
        ...
        <div class="form-fieldset">
          ...
          <form @submit.prevent="handleCreateProject">
            ...
            <!-- <VCheckbox v-model="options" value="true" label="Action" color="primary"
              @click="actionOptionsHandler(true)" />
            <VCheckbox v-model="options" value="false" label="Dont action" color="primary"
